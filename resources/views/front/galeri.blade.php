      ...
      <div class="row portfolio-container">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
          <div class="portfolio-wrap">
            <figure>
              <img src="{{asset('front')}}/img/portfolio/image 1.jpg" class="img-fluid" alt="">
            ...
            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">Foto 1</a></h4>
              <p>App</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
          <div class="portfolio-wrap">
            <figure>
              <img src="{{asset('front')}}/img/portfolio/image 2.jpg" class="img-fluid" alt="">
            ...
            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">Foto 2</a></h4>
              <p>Web</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
          <div class="portfolio-wrap">
            <figure>
              <img src="{{asset('front')}}/img/portfolio/image 3.jpg" class="img-fluid" alt="">
            ...
            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">foto 3</a></h4>
              <p>App</p>
            </div>
          </div>
        </div>
